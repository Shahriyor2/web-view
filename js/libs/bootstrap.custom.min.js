+(function (a) {
  ...
  function f(d) {
    (d && 3 === d.which) ||
      ...
      a(c).each(function () {
        ...
        c.hasClass("open") &&
          ((d && "click" == d.type && /input|textarea/i.test(d.target.tagName) && a.contains(c[0], d.target)) ||
            (c.trigger((d = a.Event("hide.bs.dropdown", f))),
            d.isDefaultPrevented() ||
              (b.attr("aria-expanded", "false"), c.removeClass("open").trigger("hidden.bs.dropdown", f))));
      }));
  }
  function g(b) {
      ...
      if (/(38|40|27|32)/.test(b.which) && !/input|textarea/i.test(b.target.tagName)) {
        ...
        if ((b.preventDefault(), b.stopPropagation(), !d.is(".disabled, :disabled"))) {
          ...
          if ((!g && 27 != b.which) || (g && 27 == b.which))
            return 27 == b.which && f.find(c).trigger("focus"), d.trigger("click");
  ...
  (a.fn.dropdown = g),
    ...
    a(document)
      ...
      .on("keydown.bs.dropdown.data-api", c, d.prototype.keydown)
      ...
      (b.prototype.show = function () {
        ...
        if (this.hasContent() && this.enabled) {
          ...
          a.support.transition && this.$tip.hasClass("fade")
            ? f.one("bsTransitionEnd", q).emulateTransitionEnd(b.TRANSITION_DURATION)
            : q();
        }
      }),
          ...
          f.isDefaultPrevented()
            ...
            : (e.removeClass("in"),
              a.support.transition && e.hasClass("fade")
                ? e.one("bsTransitionEnd", g).emulateTransitionEnd(b.TRANSITION_DURATION)
                : g(),
              (this.hoverState = null),
              this)
        );
      ...
      (a.fn.triggerNative = function (a) {
        ...
        c.dispatchEvent
          ? ("function" == typeof Event
            ...
            c.dispatchEvent(b))
          : (c.fireEvent && ((b = document.createEventObject()), (b.eventType = a), c.fireEvent("on" + a, b)),
            this.trigger(a));
      }),
                    ...
                    if ((l && n) || (m && o))
                      if (l && 1 == l)
                        ...
                        q[2] &&
                          ...
                          m &&
                            o &&
                            (t.append(a("<div>" + s + "</div>")), b.$element.trigger("maxReachedGrp.bs.select")),
                          setTimeout(function () {
                            b.setSelected(e, !1);
                          }, 10),
        ...
        liveSearchListener: function () {
          ...
          this.$newElement.on("click.dropdown.data-api touchstart.dropdown.data-api", function () {
            d.$menuInner.find(".active").removeClass("active"),
              d.$searchbox.val() &&
                (d.$searchbox.val(""), d.$lis.not(".is-hidden").removeClass("hidden"), e.parent().length && e.remove()),
                  ...
                  d.$lis.filter(".dropdown-header").each(function () {
                    ...
                    0 ===
                      d.$lis
                        ...
                        .not(b)
                        .not(".hidden").length &&
                      (b.addClass("hidden"), d.$lis.filter("[data-optgroup=" + c + "div]").addClass("hidden"));
                  });
        ...
        changeAll: function (b) {
          ...
          for (
            var c = this.$element.find("option"),
              d = this.$lis.not(".divider, .dropdown-header, .disabled, .hidden").toggleClass("selected", b),
              e = d.length,
              f = [],
              g = 0;
            e > g;
            ...
            if (/(38|40)/.test(c.keyCode.toString(10)))
                ...
                o.options.liveSearch
                  ? (c.preventDefault(),
                    m.hasClass("dropdown-toggle") ||
                      (d.removeClass("active").eq(e).addClass("active").children("a").focus(), m.focus()))
              ...
              d.each(function () {
                a(this).hasClass("disabled") ||
                  (a.trim(a(this).children("a").text().toLowerCase()).substring(0, 1) == q[c.keyCode] &&
                    t.push(a(this).index()));
              }),
